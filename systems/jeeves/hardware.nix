...

{
  ...
  boot.initrd.availableKernelModules = [ "mpt3sas" "nvme" "xhci_pci" "ahci" "uas" "usb_storage" "usbhid" "sd_mod" "sr_mod" ];
  ...
  swapDevices =
    [ { device = "/dev/disk/by-uuid/4c797a94-be32-43d3-89ac-7f02912c7cf5"; }
    ];
